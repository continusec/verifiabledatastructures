...
// Client provides a way to access a remote Verifiable Data Structures API
...
func (g *Client) Dial() (pb.VerifiableDataStructuresServiceServer, error) {
...
func (g *Client) MustDial() pb.VerifiableDataStructuresServiceServer {
	rv, err := g.Dial()
	if err != nil {
		log.Fatal(err)
	}
