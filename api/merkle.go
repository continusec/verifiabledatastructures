...
func (l *LocalService) fetchSubTreeHashes(kr KeyGetter, lt pb.LogType, ranges [][2]int64, failOnMissing bool) ([][]byte, error) {
	/*
...
func (l *LocalService) calcSubTreeHash(kr KeyGetter, lt pb.LogType, start, end int64) ([]byte, error) {
